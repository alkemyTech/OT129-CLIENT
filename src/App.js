      ...
      <Router>
        <Switch>
          <div className="container-app">
            ...
            <Route exact component={NewsContainer} path="/backoffice/news/edit/:id" />
            ...
            <Route exact component={SlidesForm} path="/backoffice/slides/edit/:id" />
            ...
            <Route exact component={UsersFormContainer} path="/backoffice/users/edit/:id" />
            ...
            <Route exact component={MembersFormContainer} path="/backoffice/members/edit/:id" />
